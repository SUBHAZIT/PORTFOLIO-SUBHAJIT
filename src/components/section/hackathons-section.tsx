        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              DURING MY TIME AT UNIVERSITY, I ACTIVELY PARTICIPATED IN MULTIPLE HACKATHONS WHERE STUDENTS FROM DIFFERENT PLACES CAME TOGETHER TO BUILD INNOVATIVE SOLUTIONS WITHIN A SHORT TIMEFRAME. IT WAS AN EYE-OPENING EXPERIENCE TO WITNESS HOW IDEAS TURN INTO REAL PRODUCTS THROUGH TEAMWORK, CREATIVITY, AND DEDICATION, WHICH FURTHER STRENGTHENED MY PASSION FOR BUILDING IMPACTFUL TECHNOLOGY.
            </p>
          </div>
        </div>
        <Timeline>
              ...
              <div className="flex flex-1 flex-col justify-start gap-2 min-w-0">
                ...
                {hackathon.links && hackathon.links.length > 0 && (
                  <div className="mt-1 flex flex-row flex-wrap items-start gap-2">
                    {(hackathon.links as unknown as any[]).map((link, idx) => (
                      <Link
                        href={link.href}
                        key={idx}
                        target="_blank"
